...
return {
	...
	-- Only attaches in Deno projects, so it stays inert in npm/node projects.
	-- workspace_required: without a deno.json{,c}/deno.lock root, do NOT start
	-- (otherwise vim.lsp falls back to single-file mode and attaches everywhere).
